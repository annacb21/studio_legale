...
class Studio {
    ...
    // constructor
    public function __construct($id, $città, $indirizzo, $cap, $telefono, $map, $foto) {
        $this->id = $id;
        $this->città = $città;
...
// class obj
$pFoto = array("padova.jpg", "padova1.jpg", "padova2.jpg");
...
$rFoto = array("roma.jpg", "roma2.jpg", "roma3.jpg");
