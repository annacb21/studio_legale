...
<nav class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            <li>
                <a href="index.php" class="<?php if(!isset($_GET['post'])){echo "admin-active";} else {echo "";} ?>"><i class="fas fa-chart-line"></i><span>Dashboard</span></a>
            </li>
            <li>
                <a href="index.php?post" class="<?php if(isset($_GET['post'])){echo "admin-active";} else {echo "";} ?>"><i class="far fa-newspaper"></i><span>Post</span></a>
            </li>
            <li>
